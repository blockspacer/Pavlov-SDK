...
enum class CohtmlPlugin_ECohtmlKeys : uint8_t
{
...
enum class CohtmlPlugin_ECohtmlImageFormat : uint8_t
{
...
enum class CohtmlPlugin_ECohtmlMSAA : uint8_t
{
...
enum class CohtmlPlugin_ECohtmlSettingsSeverity : uint8_t
{
...
enum class CohtmlPlugin_ECohtmlInputPropagationBehaviour : uint8_t
{
...
enum class CohtmlPlugin_ECohtmlGamepadBehaviourOnFocusLost : uint8_t
{
	CohtmlResetState               = 0,
...
enum class CohtmlPlugin_ECohtmlInputWidgetLineTraceMode : uint8_t
{
...
enum class CohtmlPlugin_ECohtmlInputWidgetRaycastQuality : uint8_t
{
...
struct FCohtmlSound
{
	...
	unsigned char                                      UnknownData_DO42[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	CohtmlPlugin_ECohtmlImageFormat                    BaseFormat;                                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WR3M[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<CohtmlPlugin_ECohtmlImageFormat>            PossibleFallbacks;                                         // 0x0008(0x0010) (Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
{
	TMap<struct FString, class UCohtmlAtlasContainedTextures*> AtlasContainedTextures;                                    // 0x0000(0x0050) (ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<struct FString, class UCohtmlTextureAtlasDetails*> AtlasDetails;                                              // 0x0050(0x0050) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_0FYE[0x60];                                    // 0x00A0(0x0060) MISSED OFFSET (PADDING)
...
{
	struct FString                                     AtlasPath;                                                 // 0x0000(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                Width;                                                     // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                Height;                                                    // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                OriginX;                                                   // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                OriginY;                                                   // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FCohtmlViewSettings
{
	...
	unsigned char                                      UnknownData_KL6V[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
