...
{
public:
	unsigned char                                      UnknownData_GIGN[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KMZE[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OCLH[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7LFJ[0x68];                                    // 0x0028(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BYJ1[0x180];                                   // 0x0088(0x0180) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_OHDK3BWMVN[0x01];                                      // 0x008F(0x0001) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_VKME4QPOQ9[0x04];                                      // 0x00AC(0x0004) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_7376[0x68];                                    // 0x0208(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MIUS[0xB8];                                    // 0x0028(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KYJM[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MKVI[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_10HO[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XVAO[0x1B8];                                   // 0x0208(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1DOY[0xC8];                                    // 0x0028(0x00C8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J8IR[0x1B8];                                   // 0x00B8(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N9EI[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZJ4F[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LO42[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4DZ2[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UFHG[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8BLL[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2TEI[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_46JL[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q19M[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GMTS[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6BDJ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1ITX[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NVDD[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1BSL[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
