...
// 0x1470 (FullSize[0x1850] - InheritedSize[0x03E0])
...
public:
	...
	unsigned char                                      UnknownData_VLQ9[0x8];                                     // 0x0468(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass ZFemale_AnimBlueprint.ZFemale_AnimBlueprint_C");
		return ptr;
	}
