...
// 0x04D0 (FullSize[0x08A0] - InheritedSize[0x03D0])
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass SK_VRHand_R_Skeleton_AnimBlueprint.SK_VRHand_R_Skeleton_AnimBlueprint_C");
		return ptr;
	}
