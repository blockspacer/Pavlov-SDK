...
public:
	...
	unsigned char                                      UnknownData_B7VW[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_U0XJ[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZL0Y[0x48];                                    // 0x0048(0x0048) MISSED OFFSET (PADDING)
