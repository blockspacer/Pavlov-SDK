...
struct FGuardianTestResult
{
	...
	unsigned char                                      UnknownData_QAOS[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOculusSplashDesc
{
	...
	unsigned char                                      UnknownData_N4BY[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3NZ5[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ABVN[0x1F];                                    // 0x0081(0x001F) MISSED OFFSET (PADDING)
...
struct FHmdUserProfile
{
	...
	unsigned char                                      UnknownData_EOZD[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
