...
{
	unsigned char                                      UnknownData_5Y94[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FSubdividedWireEdge
{
	...
	unsigned char                                      UnknownData_KK6T[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JZKE[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshElementAttributeData
{
	...
	unsigned char                                      UnknownData_GVYQ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEdgeToCreate
{
	...
	unsigned char                                      UnknownData_PEQA[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPolygonGroupToCreate
{
	...
	unsigned char                                      UnknownData_M32X[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FPolygonToCreate
{
	...
	unsigned char                                      UnknownData_2GDS[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FVertexInstanceToCreate
{
	...
	unsigned char                                      UnknownData_8CXY[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QVI3[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FVertexToCreate
{
	...
	unsigned char                                      UnknownData_EPKY[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAttributesForEdge
{
	...
	unsigned char                                      UnknownData_0JWK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_1MCI[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FVertexInstanceID                           VertexInstanceID;                                          // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OWP1[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMeshElementAttributeList                   VertexInstanceAttributes;                                  // 0x0008(0x0010) (BlueprintVisible, NativeAccessSpecifierPublic)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_O2D1[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRenderingPolygonGroup
{
	...
	unsigned char                                      UnknownData_HTF6[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
struct FRenderingPolygon
{
	...
	unsigned char                                      UnknownData_1TR5[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
