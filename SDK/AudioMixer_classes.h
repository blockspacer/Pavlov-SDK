...
{
public:
	unsigned char                                      UnknownData_20M3[0x8];                                     // 0x0238(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_UWMM[0x3];                                     // 0x0541(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7S35[0x4];                                     // 0x054C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E0VN[0x20];                                    // 0x0560(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TXCD[0x30];                                    // 0x0590(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8CUU[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_AFK8[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_69C3[0x5C];                                    // 0x0040(0x005C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_AOBZ[0x20];                                    // 0x0260(0x0020) MISSED OFFSET (PADDING)
